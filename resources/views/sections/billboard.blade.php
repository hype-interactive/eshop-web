<div id="default-carousel" class="relative w-full" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative overflow-hidden h-60 md:h-96" style="height: 550px;">
        <!-- Carousel items -->
    ...
    <!-- Slider indicators -->
    <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-2 sm:space-x-3 rtl:space-x-reverse">
