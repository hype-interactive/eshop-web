                    ...
                    <div class="flex justify-between h-20">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                                ...
                                <a href="#" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"> All Items </a>
                            </div>
                        </div>
        ...
        <div class=" border-gray-700 pt-8">
            <div class="flex justify-between">
                <div class="flex flex-col">
                    <img class="h-20 w-32" src="{{ asset('loginSlider/icon.png') }}" alt="eShops Logo">
