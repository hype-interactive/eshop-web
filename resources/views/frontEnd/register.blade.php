    ...
    <div class="w-full max-w-full bg-white shadow-xl flex rounded-lg overflow-hidden h-full">
        ...
        <div class="w-1/2 flex flex-col mycontent  ml-12 px-4  py-12 px-16">
            <div class="flex flex-col  mb-8">
                ...
                <h2 class="text-3xl font-semibold text-gray-700 ">Sign Up to Create  <br> <span class="font-serif italic">your account</span></h2>
            </div>
            <div class="flex-grow flex  ">
                <form action="{{ route('customer-registration') }}"  method="POST" class="w-full space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="last_name" name="full_name" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Your Full Name" required />
                    ...
                    <div class="flex justify-between">
                      <div class="flex p-2">
                        ...
                        <div class="text-sm text-center">
                            Already have an account? <a href="{{ route('customer-login') }}" class="text-blue-600 hover:text-blue-500">Login</a>
                        </div>
                    ...
                    <div>
                        <button type="submit" class="w-full  text-white py-2 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" style="background-color: #1c70cd">Create Account</button>
                    </div>
                </form>
