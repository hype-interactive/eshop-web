...
<div>
    ...
    <aside id="sidebar"
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center  justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3">Dashboard</span>
                    </div>
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3">Orders </span>
                    </div>
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3">Inventory </span>
                    </div>
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3">Vendors </span>
                    </div>
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3">Customers</span>
                    </div>

                    <div class="flex shrink-0 ml-2 duration-200"></div>
                </div>
                <div class="absolute left-0 -ml-6 top-0 bottom-0 w-3 bg-gradient-to-r from-[#F5AD42] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
            </li>
            ...
            <li class="relative px-4 py-2 mb-4 last:mb-0 cursor-pointer group">
                <div wire:click="selectedMenu(0)" wire:loading.attr="disabled" class="flex items-center justify-between text-white  hover:text-[#F5AD42] truncate transition duration-150">
                    <div class="flex items-center">
                        ...
                        <span class="text-base  hover:text-[#F5AD42] text-white font-bold ml-3"> Settings</span>
                    </div>
        ...
        <hr class="bg-gray-50 mx-4 mt-4 color-gray-100">

        <ul class=" py-6  mt-3 ml-4  ">
