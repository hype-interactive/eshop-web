        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button wire:click="selectedMenu(2)" type="button"
                ...
                <form class="flex-grow flex items-center mx-4 mt-2 rounded-full border border-gray-300">
                ...
                <div class="flex items-center space-x-4 mb-2">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center bg-white border border-blue-500">
                        <svg data-slot="icon" fill="none" class="w-7 h-7 text-blue-500" stroke-width="1.5" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="relative w-10 h-10 rounded-full flex items-center justify-center bg-white border border-blue-500">
                        <svg data-slot="icon" class="w-7 h-7 text-blue-500" fill="none" stroke-width="1.5" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center bg-white border border-blue-500">
                        <svg data-slot="icon" fill="none" class="w-7 h-7 text-blue-500" stroke-width="0.2" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
