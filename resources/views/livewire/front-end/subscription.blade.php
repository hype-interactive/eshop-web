            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap justify-center justify-between ">
                    ...
                    <div class="w-full md:w-1/3 bg-white rounded-3xl  border-1 shadow p-1">
                        ...
                        <ul class="mb-6">
                            <li class="flex items-center mb-2"><svg data-slot="icon" fill="#189009"
                                    class=" w-6 h-6 text-[#F5AD42] " stroke-width="1.5" stroke="white" viewBox="0 0 24 24"
                            ...
                            <li class="flex items-center mb-2 text-gray-400"><svg data-slot="icon" fill="#189009"
                                    class=" w-6 h-6 text-[#F5AD42] " stroke-width="1.5" stroke="white" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"></path>
                        ...
                        <button class="bg-white text-[#1C70CD] border font-bold  px-4 py-2 rounded-md w-full">Chose
                            Plan</button>
                    </div>
                    ...
                    <div class="w-full md:w-1/3 bg-[#1C70CD] -mt-6 mb-6 rounded-3xl  shadow p-6 border-2 border-[#F5AD42]">
                        ...
                        <p class="text-gray-600 text-white mb-4">Lorem Ipsum is simply dummy text of the printing and
                            typesetting industry.</p>
                        <p class="text-4xl text-white font-bold mb-4">Tsh 6000 <span class="text-lg font-normal">/mo</span>
                        </p>
                        <h4 class="text-lg text-white font-bold mb-2">What's included:</h4>
                        <ul class="mb-6 ">
                            <li class="flex items-center text-white mb-2"> <svg data-slot="icon" fill="#189009"
                                    class=" w-6 h-6 text-[#F5AD42] " stroke-width="1.5" stroke="white" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"></path>
                            ...
                            <li class="flex items-center text-white mb-2"> <svg data-slot="icon" fill="#189009"
                                    class=" w-6 h-6 text-[#F5AD42] " stroke-width="1.5" stroke="white"
                        ...
                        <div class="flex">
                            <button
                                class="bg-white  text-[#1C70CD] px-4 py-4 item-center justify-center rounded-3xl w-full font-bold  ">Chose
                                Plan</button>
                        </div>
                    </div>
