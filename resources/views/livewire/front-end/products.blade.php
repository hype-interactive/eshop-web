            ...
            <div class="w-1/5 pr-4 mb-8 lg:mb-0 lg:h-screen lg:sticky lg:top-0 overflow-y-auto mr-6">
                <div class="bg-white border mb-8 rounded-md">
                    ...
                    <ul class="space-y-2 overflow-y-auto h-[200px] overflow-x-auto px-4">
                        <li><a href="#" class="block text-blue-600 text-sm hover:text-blue-800">All</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Food</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Cosmetics</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Cleaning Products</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Nuts</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Spices</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Handmade</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Handmade</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Handmade</a></li>
                        <li><a href="#" class="block text-gray-700 text-sm hover:text-blue-800">Handmade</a></li>
