                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-20 items-center">
                        ...
                        <div class="flex items-center ">
                            <img class="h-16 w-auto" src="{{ asset('images/icon.png') }}" alt="eShops Logo">
                        ...
                        <form class="flex-grow flex items-center rounded-full border border-gray-300">
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('view-cart') }}" class="relative">
